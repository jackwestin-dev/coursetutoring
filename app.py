...
def grade_session():
    try:
        ...
        if grader.course_type == 'cars':
            ...
            response_data['a_total'] = findings.get('a_total', 0)
            response_data['b_total'] = findings.get('b_total', 0)
            response_data['c_total'] = findings.get('c_total', 0)
            response_data['d_total'] = findings.get('d_total', 0)
            response_data['raw_total'] = findings.get('raw_total', 0)
